describe('Details', () => {
    ...
    it('Should show list of book types', () => {
      cy.get('h2').should('be.visible')
        ...
        cy.get('.listItem').eq(0).should('contain', 'Combined Print & E-Book Fiction')
        cy.get('.listItem').eq(1).should('contain', 'Combined Print & E-Book Nonfiction')
        // .get('.listItem').contains('Combined Print & E-Book Fiction')
        // .get('.listItem').contains('Combined Print & E-Book Nonfiction')
        .get('h2').should('not.exist')
    })
});
